    ...
    <div className='skills-page'>
      <div className='text-zone'>
        ...
        <p className='textSkills'>
          ...
          <br />
          Soy un apasionado a la tecnologia y estoy desarrollando sitios web receptivos, faciles de usar construidos con las mejores practicas. Estoy ganando experiencia en el desarrollo front-end con HTML, CSS, JS con el uso de la libreria de ReactJS, creando pequeñas aplicaciones personalizadas, funciones, animaciones y diseños interactivos.
          <br />
          Si estas interesado en mi trabajo puedes visitar mi perfil de <a className='linkText' href='https://www.linkedin.com/in/juan-sebastian-giraldo-varon-b36689222/' target='_blank'>Linkedin</a> o simplemente <Link className='linkText' to='/contact'>contactame</Link>.
        </p>
      </div>
