            ...
            <CardGroup className='cardsContainer'>
                ...
                <Card>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            Aplicación creada con ReactJS consumiendo la API de Pokemon, implementacion de Redux con sistema de proteccion de rutas, implementacion de CRUD, inicio de sesion con firebase para google, facebook y autenticacion de correo electronico.
                        </Card.Text>
                    </Card.Body>
                </Card>
